odoo.define('sale.order.line', function (require) {
"use strict";
...
var ProductConfigurator = form_common.FormWidget.extend({
    ...
    */
	...
	start: function() {
        this._super();
        this.field_manager.on("field_changed:opencpq_configurator", this, this.display_configurator);
        this.display_configurator();
    },
    
    display_configurator: function() {
        this.$el.html(QWeb.render("WidgetConfigurator", {
            "configurator": this.field_manager.get_field_value("opencpq_configurator") || 0,
        }));
    }
